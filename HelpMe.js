...
span3.onclick = function() {
    ...
    button3.style.border = "hidden";
}

 button1.addEventListener("mouseover", function( event ) {   
    // highlight the mouseover target
    if(button2.style.border == "5px solid gray"){
        return;
    }
     if(button3.style.border == "5px solid gray"){
        return;
    }
  ...
  button2.addEventListener("mouseover", function( event ) {   
    // highlight the mouseover target
       if(button1.style.border == "5px solid gray"){
        return;
    }
     if(button3.style.border == "5px solid gray"){
        return;
